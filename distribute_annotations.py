...
for i in range(30):
    ...
    outfile.write(r"<div>Lama Events detecteert volledig automatisch gebeurtenissen in de grote " + \
        ...
        "<div><em>Een gebeurtenis vindt plaats op een specifiek tijdstip en is van belang voor een grotere " + \
        "groep mensen.&nbsp;</em></div><div>&nbsp;</div><div>Sportwedstrijden en wetsveranderingen zijn in " + \
        "deze definitie een gebeurtenis, terwijl een vakantie naar Turkije te persoonlijk is om een " + \
        "gebeurtenis te zijn.<br /><br />Verder is het belangrijk dat de 5 tweets naar dezelfde gebeurtenis " + \
        ...
        "gebeurtenis overkoepeld.&nbsp;<br /><br />Events worden soms met hashtags aangeduid, zoals #tvoh " + \
        "voor &#39;The Voice of Holland&#39;, of #ajafey voor &#39;Ajax-Feyenoord&#39;. Ook dit wordt gezien " + \
        "als een correcte verwijzing.&nbsp;<br /><br />Als je de eerste vraag bevestigend beantwoord volgt nog " + \
        ...
        "afdoende informatie over wat voor gebeurtenis het is?<br /><br />Veel succes!</div>")
    j = i
    print i,"index",j
    indexes = range(50)
    index_event = {}
