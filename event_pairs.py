...
class Event_pairs:
    ...
    def extract_date(self,new_tweets):
        ...
        days = re.compile(r"(over|nog) (maar |slechts |pakweg )?(een kleine |iets (meer|minder) dan )?" + (nums) + " " + (timeunits),re.IGNORECASE)
        ...
        days3 = re.compile((nums) + " " + (timeunits) + " tot",re.IGNORECASE)
